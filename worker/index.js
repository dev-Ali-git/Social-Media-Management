...
async function startDaemon() {
    console.log('======================================================');
    console.log('OmniPost Playwright Daemon Engine Started');
    console.log('Watching for scheduled and immediate uploads...');
    console.log('======================================================\n');
    ...
    setInterval(async () => {
        try {
            ...
            const currentTimeStr = `${currentHour}:${currentMin}`; // e.g. "15:30"
            ...
            if (activeProfiles.length > 0) {
                ...
                if (eligibleProfiles.length > 0) {
                    ...
                    // Process all eligible profiles CONCURRENTLY using Promise.all, but don't await it to block the interval
                    Promise.all(eligibleProfiles.map(async ([profileId, profileData]) => {
                        try {
